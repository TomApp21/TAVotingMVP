...
namespace DomainLayer.Models.Voter
{
    public class VoterModel : IVoterModel
    {
        ...
        [StringLength(10, MinimumLength = 10, ErrorMessage = "DOB must be in the correct format.")]
        public string DateOfBirth { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "Address is required")]
        [StringLength(20, MinimumLength = 1, ErrorMessage = "Address must be between 1 and 20 characters")]
        ...
        [StringLength(20, MinimumLength = 1, ErrorMessage = "Postcode must be between 2 and 10 characters")]
